...
(function() {
  ...
  Schema.statics.calculate_hash = calculate_hash = (function(block_obj) {
    var arr, _ref, _ref1;
    arr = [block_obj.index, block_obj.ctime, (_ref = block_obj.prev) != null ? _ref : null, block_obj.difficulty, block_obj.solver, block_obj.proof, JSON.stringify((_ref1 = block_obj.data) != null ? _ref1 : {})];
